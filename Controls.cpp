...
void CCheckBox::Draw(bool hover)
{
	...
	if (Checked)
	{
		if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 0)
		{
			...
			Render::GradientV(a.x, a.y, 10, 10, Color(255, 0, 0, 255), Color(255, 0, 0, 255));
		}
...
void CGroupBox::Draw(bool hover)
{
	...
	Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(110, 50, 50, 1));
	Render::Text(a.x + (m_iWidth / 2) - (txtSize.right / 2), a.y - (txtSize.bottom / 2) - 1, Color(255, 0, 0, 255), Render::Fonts::Menu, Text.c_str());

	//Color(48, 48, 48, 255)

	Render::Line(a.x, a.y, a.x + (m_iWidth / 2) - (txtSize.right / 2) - 2, a.y, Color(255, 0, 0, 255));
	Render::Line(a.x + (m_iWidth / 2) + (txtSize.right / 2) + 2, a.y, a.x + m_iWidth, a.y, Color(255, 0, 0, 255));
...
void CSlider::Draw(bool hover)
{
	...
	if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 0)
	{
		...
		Render::GradientV(a.x, a.y + 1, Location, 7, Color(255, 0, 0, 200), Color(255, 0, 0, 200));
	}
	else if (Menu::Window.ColorsTab.ControlColor.GetIndex() == 1)
	{
		red = 255;
...
void CButton::Draw(bool hover)
{
	...
	Render::Text(TextX, TextY - 1, Color(200, 200, 200, 255), Render::Fonts::Menu, Text.c_str());
}
...
void CSlider2::Draw(bool hover)
{
	...
	Render::Clear(a.x, a.y + 5, m_iWidth, 9, Color(40, 40, 40, MenuAlpha));
	Render::Clear(a.x, a.y + 5, Location, 9, Color(163, 0, 0, MenuAlpha));
