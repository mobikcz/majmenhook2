...
void CLegitBot::SyncWeaponSettings()
{
	...
	else if (GameUtils::IsMachinegun(pWeapon))
	{
		...
		RecoilControl = Menu::Window.LegitBotTab.WeaponMGRecoil.GetState();
		PSilent = Menu::Window.LegitBotTab.WeaponMGPsilent.GetState();
		Inacc = Menu::Window.LegitBotTab.WeaponMGInacc.GetValue();
	...
	else if (GameUtils::IsShotgun(pWeapon))
	{
		...
		RecoilControl = Menu::Window.LegitBotTab.WeaponShotgunRecoil.GetState();
		PSilent = Menu::Window.LegitBotTab.WeaponShotgunPsilent.GetState();
		Inacc = Menu::Window.LegitBotTab.WeaponShotgunInacc.GetValue();
	...
	else if (GameUtils::IsMP(pWeapon))
	{
		...
		RecoilControl = Menu::Window.LegitBotTab.WeaponMpRecoil.GetState();
		PSilent = Menu::Window.LegitBotTab.WeaponMpPsilent.GetState();
		Inacc = Menu::Window.LegitBotTab.WeaponMpInacc.GetValue();
...
void CLegitBot::LegitAA(CUserCmd *pCmd, bool& bSendPacket)
{
	...
	if (Menu::Window.LegitBotTab.LegitAA.GetState())
	...
	float oldSideMove = pCmd->sidemove;
	if (Menu::Window.LegitBotTab.LegitAA.GetState() && !pCmd->buttons & IN_ATTACK)
	{
		static int ChokedPackets = -1;
		ChokedPackets++;
		static bool yFlip;
