...
//	CPNETVAR_FUNC(AttributeContainer*, m_AttributeManager, 0xCFFCE089);
	...
	void SetAngle2(Vector3D wantedang)
	{
		typedef void(__thiscall* SetAngleFn)(void*, const Vector3D &);
...
//typedef unsigned short MaterialHandle_t; //this shit hels with nightmode so you better keep it here.